...
/**
 * 加密解密工具类
 * @author lr 2015年11月26日 下午2:36:00
 * 
 */
public class DESUtil
{
    ...
    /** 字符串默认键值 */
    private static String strDefaultKey = "tsfplatform1@#";
    ...
    public static void init() throws Exception
    {
        ...
        if(key == null)
        {
            ...
            key = getKey(strDefaultKey.getBytes("utf-8"));
        }
    ...
    public static String getUserCode(String token) throws Exception
    {
